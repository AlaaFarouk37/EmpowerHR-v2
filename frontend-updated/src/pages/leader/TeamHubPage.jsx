...
function TeamOvertimeReviewSection() {
  const { t } = useLanguage();
    ...
    <div style={{ padding: '0 32px 32px' }}>
      <div className="card" style={{ padding: '20px 22px', borderRadius: 18 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'center', flexWrap: 'wrap', marginBottom: 14 }}>
          <div>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#B54708', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: 4 }}>
              {t('Pending Overtime Reviews')}
            </div>
            <div style={{ fontSize: 12.5, color: 'var(--gray-500)', maxWidth: 620 }}>
