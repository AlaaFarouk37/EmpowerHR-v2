...
import { PriorityShiftQueue } from '../../components/employee/PriorityShiftQueue.jsx';
import { ShiftPlaybook } from '../../components/employee/ShiftPlaybook.jsx';
import { ShiftRadar } from '../../components/employee/ShiftRadar.jsx';
    ...
    <div className="hr-page-shell" style={{ maxWidth: 1180, margin: '0 auto', padding: '40px 32px 80px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16, marginBottom: 24 }}>
        {[
          ...
          { label: t('Upcoming'), value: stats.upcoming, accent: 'var(--pink-400)' },
          { label: t('Completed'), value: stats.completed, accent: 'var(--red-800)' },
        ].map((card) => (
      ...
      <div className="hr-panel-grid" style={{ gridTemplateColumns: '1.1fr .9fr', marginBottom: 24 }}>
        <div style={{ display: 'grid', gap: 16 }}>
          ...
          <PriorityShiftQueue 
            shifts={shiftFocusQueue}
            getShiftWindowLabel={getShiftWindowLabel}
            getShiftTone={getShiftTone}
          />
        </div>

        <div style={{ display: 'grid', gap: 16 }}>
          <ShiftPlaybook plays={shiftPlaybook} />
            ...
            {shiftTypePressureMap.length === 0 ? (
              ...
              <div style={{ display: 'grid', gap: 10 }}>
                {shiftTypePressureMap.map((item) => (
                  <div key={item.shiftType} style={{ border: '1px solid var(--border-primary)', borderRadius: 14, padding: '12px 14px', background: 'var(--bg-surface)' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: 8, marginTop: 10 }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontWeight: 700, color: 'var(--red-800)' }}>{item.swappedCount}</div>
                      </div>
                      <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12, alignItems: 'end' }}>
                  <div>
                    ...
                    <select
                      ...
                      style={{ width: '100%', padding: '10px 12px', borderRadius: 12, border: '1px solid var(--border-primary)', background: 'var(--bg-surface)' }}
                    >
