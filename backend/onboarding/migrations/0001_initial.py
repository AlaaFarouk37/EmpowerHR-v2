    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(db_column='employeeID', on_delete=django.db.models.deletion.CASCADE, related_name='onboarding_plans', to='employee_management.employee')),
            ],
            options={
