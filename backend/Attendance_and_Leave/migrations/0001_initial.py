...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='LeaveRequest',
            fields=[
                ('leaveRequestID', models.CharField(default=Attendance_and_Leave.models.gen_id, max_length=50, primary_key=True, serialize=False)),
                ...
                ('employee', models.ForeignKey(db_column='employeeID', on_delete=django.db.models.deletion.CASCADE, related_name='leave_requests', to='employee_management.employee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('attendanceID', models.CharField(default=Attendance_and_Leave.models.gen_id, max_length=50, primary_key=True, serialize=False)),
                ...
                ('employee', models.ForeignKey(db_column='employeeID', on_delete=django.db.models.deletion.CASCADE, related_name='attendance_records', to='employee_management.employee')),
            ],
            options={
